...
- (void)setDateViewWithTitle:(NSString *)title
{
    ...
    UIButton *submit = [[UIButton alloc] initWithFrame:CGRectMake(SCREENSIZE.width - 50, 10, 50 ,39.5)];
    ...
    UIButton *cancel = [[UIButton alloc] initWithFrame:CGRectMake(0, 10, 50 ,39.5)];

...
- (NSDictionary *)mfs_propertyDictionary
{
    ...
    Class cls = Nil;
    if ([((id<LYJSONEntityPropertyProtocol>)self) respondsToSelector:@selector(ownPropertysUntilClass)]) {
        cls = [((id<LYJSONEntityPropertyProtocol>)self) ownPropertysUntilClass];
    }
